...
#if defined(_PLATFORM_BANANAPI_R4_) || !defined(ONEWIFI_RDKB_APP_SUPPORT)
...
wifi_lq_descriptor_t *get_lq_descriptor()
{
    ...
    if (!initialized) {
#if !defined(_PLATFORM_BANANAPI_R4_) &&  (ONEWIFI_RDKB_APP_SUPPORT || defined(_GREXT02ACTS_PRODUCT_REQ_))
